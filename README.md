...
<p align="center">
  <a href="https://github.com/Reacien/reacien.dev/actions"><img alt="build" src="https://img.shields.io/github/actions/workflow/status/Reacien/reacien.dev/update-build.yml?branch=main&style=flat-square&logo=githubactions&logoColor=white"></a>
  <a href="https://reacien.dev"><img alt="live site" src="https://img.shields.io/website?url=https%3A%2F%2Freacien.dev&style=flat-square&label=reacien.dev"></a>
  <a href="https://getkirby.com"><img alt="kirby cms" src="https://img.shields.io/badge/kirby-5.x-f0c330?style=flat-square&logoColor=black"></a>
  <a href="https://php.net"><img alt="php version" src="https://img.shields.io/badge/php-8.2-777BB4?style=flat-square&logo=php&logoColor=white"></a>
  <a href="LICENSE"><img alt="license" src="https://img.shields.io/github/license/Reacien/reacien.dev?style=flat-square"></a>
</p>

> [!TIP]
> Press <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>K</kbd> on the live site to open the keyboard command palette.

## ## foundations

- **Engine:** `Kirby 5.x` (Flat-file architecture) + `PHP 8.2`
- **Frontend:** Vanilla JS (~14kb) · Modern CSS (OKLCH, Logical Properties, Native Variables)
- **Typography:** `Instrument Serif` (Display) · `JetBrains Mono` (UI/Terminal bits)
- **Build System:** GitHub Actions (Writes `BUILD.json` on each push)
